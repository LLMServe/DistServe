...
client_cmdline="python3 ../simulate_dist.py --backend distserve --N {N} --workload {workload} --rate {rate} ${config_tpl} ${output_tpl}"
...
client_cmdline="python3 ../simulate_dist.py --backend vllm --N {N} --workload {workload} --rate {rate} ${config_tpl} ${output_tpl}"
